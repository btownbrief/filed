// Monthly public leaderboard backed by Supabase (shared Btown Games project).
// Database schema lives in the Church Street Runner repo's supabase/schema.sql;
// the same tables/functions serve every Btown game, keyed by the GAME string.
//
